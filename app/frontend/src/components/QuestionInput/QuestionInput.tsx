            ...
            {!!followupQuestions?.length && (
                <Stack horizontal wrap tokens={{ childrenGap: 16 }} className={styles.followupQuestionsWrapper}>
                    {followupQuestions.map((q, i) => (
                        <button key={i} className={styles.followupQuestion} title={q} onClick={() => onFollowupQuestionClicked?.(q)} type="button">
                            {q}
                        </button>
                    ))}
                </Stack>
                        ...
                        if (attachment.type === "jira") {
                            return (
                                ...
                                >
                                    ...
                                    >
                                        <img src={jiraLogo} alt="Jira" style={{ width: 16, height: 16 }} />[{attachment.key}]
                                    </span>
                                    {attachment.url ? (
                                        <a
                                            href={attachment.url}
